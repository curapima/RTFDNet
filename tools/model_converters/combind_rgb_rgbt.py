...
def main():
    ...
    parser.add_argument('--src',default=r'/root/RXDistill/tools/work_dirs\segformer_branch_mf_mit-b4_bit/thermal_b4_53.33/best_mIoU_epoch_82.pth',help='src model path or url')
    parser.add_argument('--src2', default=r'/root/RXDistill/tools/work_dirs\segformer_branch_mf_mit-b4_bit/rgb_b4_55.0/best_mIoU_epoch_100.pth',help='src model path or url')
    parser.add_argument('--src3', default=r'/root/RXDistill/pretrain/best_mIoU_epoch_100.pth',help='src model path or url')
    parser.add_argument('--dst',default='/root/RXDistill/pretrain/mix_eaef.pth', help='save path')
