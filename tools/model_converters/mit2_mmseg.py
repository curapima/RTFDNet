...
def main():
    ...
    parser.add_argument('--src',default=r'D:\UniEAEF\pretrain\mit_b2.pth', help='src model path or url')
    # The dst path must be a full path of the new checkpoint.
    parser.add_argument('--dst',default=r'D:\UniEAEF\pretrain\mmseg_mit_b2.pth', help='save path')
