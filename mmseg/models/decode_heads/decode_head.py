...
class BaseDecodeHead(BaseModule, metaclass=ABCMeta):
    ...
    @abstractmethod
    def forward(self, inputs, inputs_x, fuse_x):
    ...
    def loss_by_feat(self, seg_logits: Tensor, 
        ...
        for loss_decode_modal in losses_decode_modal:
            if loss_decode_modal.loss_name not in loss:
                loss[loss_decode_modal.loss_name] = loss_decode_modal(
                    ...
                    seg_logits_fuse,
                    weight=seg_weight,
                    ignore_index=self.ignore_index) + loss_decode_modal(
                    seg_logits_x,
                    seg_logits_fuse,
                    weight=seg_weight,
                    ignore_index=self.ignore_index)
        ...
        loss['acc_seg_x'] = accuracy(
            seg_logits_x, seg_label, ignore_index=self.ignore_index)
        
        loss['acc_seg_fuse'] = accuracy(
