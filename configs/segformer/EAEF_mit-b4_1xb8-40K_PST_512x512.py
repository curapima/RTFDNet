...
data_root = '/root/autodl-tmp/ade_pst/'
dataset_type = 'PST_ADE20KDataset'
default_hooks = dict(
    checkpoint=dict(
        interval=10,
        max_keep_ckpts=10,
...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode_head=[
            dict(type='RegionL1', loss_weight=1.0, tau=1.0, N_cls=5),
        ],
...
work_dir = '/root/autodl-fs/work_dirs\\segformer_branch_pst_mit-b4_bit'
