...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        seg_pad_val=255,
        size=(480,640)),
    pretrained='/root/mmsegmentation/pretrain/bit_seg_mit_b3.pth',
    backbone=dict(
    ...
    decode_head =dict(
        ...
        loss_decode_head = [
            dict(type='CKDCELoss', loss_weight=5.0)
        ],
    ),
    train_cfg=dict(),
    test_cfg=dict(mode='whole'))
dataset_type = 'MSRS_ADE20KDataset'
data_root = '/root/mmsegmentation/dataset/ade_mf/'
...
launcher = 'none'
work_dir = './work_dirs\\segformer_mf_EAEFdistill_mit-b2_bit'
