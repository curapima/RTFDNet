...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        std=[
            58.395, 57.12, 57.375, 58.395, 57.12, 57.375
        ],
        bgr_to_rgb=True,
        pad_val=0,
        seg_pad_val=255,
        size=(480,640)),
    pretrained='D:/UniEAEF/pretrain/bit_seg_mit_b2.pth',
    backbone=dict(
    ...
    decode_head =dict(
        ...
        loss_decode_akd=[
            dict(loss_weight=5.0, type='AKDLoss'),
        ],
        loss_decode_head=[
            dict(type='ChannelWiseDivergence', tau=1.0, loss_weight=1.0),
        ],
    ),
    train_cfg=dict(),
...
#load_from = r"D:\UniEAEF\pretrain\best_mIoU_epoch_50.pth"
launcher = 'none'
work_dir = './work_dirs\\EAEF_k_segformer_mf_branch_mit-b2_bit'
