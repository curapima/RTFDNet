...
data_root = '/root/autodl-tmp/ade_nyu/',
dataset_type = 'NYU_ADE20KDataset'
default_hooks = dict(
    checkpoint=dict(
        interval=10,
        max_keep_ckpts=10,
...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode_akd=[
            dict(loss_weight=1.0, type='AKDLoss'),
        ],
        loss_decode_head=[
            dict(loss_weight=1.0, tau=1.0, type='RegionL1'),        ],
...
work_dir = './work_dirs\\segformer_branch_NYU_mit-b4_bit'
